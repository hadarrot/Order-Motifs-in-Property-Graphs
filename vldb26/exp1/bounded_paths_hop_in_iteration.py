...
# python3 ./bounded_paths_hop_in_iteration.py --password "ItayBachar88" --nodes 100 1000 10000 100000 1000000 100000
# -----------------------------------------------------------------------------
...
def main():
    ...
    for N in args.nodes:
        ...
        for D in args.densities:
            ...
            # Structure: H -> { "base": [latencies], "lift": [latencies], "build": [ms], ... }
            experiment_data = {
                h: {"base": [], "lift": [], "build": [], "base_to": 0, "lift_to": 0} 
                for h in args.hops
            }
            ...
            for r in range(args.repeats):
                ...
                try:
                    ...
                    for H in args.hops:
                        ...
                        # Store build time for this specific hop test (it shares the build cost)
                        ...
                        try:
                            ...
                            print(f"    Baseline: {t_sec*1000:.2f}ms")
                        except TimeoutError:
                        ...
                        try:
                            ...
                            print(f"    Lifted:   {t_sec*1000:.2f}ms")
                        except TimeoutError:
            ...
            for H in args.hops:
                ...
                print(f"  Hops={H} | Base={b_mean:.2f}ms | Build={build_avg:.2f}ms | Lift={l_mean:.2f}ms | Speedup={speedup:.2f}x")
